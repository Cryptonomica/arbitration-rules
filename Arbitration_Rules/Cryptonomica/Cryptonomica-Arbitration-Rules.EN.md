...
- [ANNEX](#annex)
    ...
    - [Model arbitration clause for contracts made on Confideal platform](#model-arbitration-clause-for-contracts-made-on-confideal-platform)
...
Original text is [GitHub Flavored Markdown](https://help.github.com/articles/github-flavored-markdown/) signed by [OpenPGP](http://www.openpgp.org/) key, and published on github: https://github.com/Cryptonomica/arbitration-rules
...
- in electronic form: via transaction on the Ethereum blockchain using smart conracts created on [Confideal](https://confideal.io) platform made from the Ethereum address verified on [cryptonomica.net](https://cryptonomica.net)
...
1.The party or parties initiating recourse to arbitration (hereinafter called the "claimant") shall send to the Cryptonomica to email address [registrar@international-arbitration.org.uk](mailto:registrar@international-arbitration.org.uk) or via smart contract as stated above the claim, that should contain:
...
5.To the statement of claim have to be attached, as far as possible, all documents and other evidence relied upon by the claimant, or links to them, in particular, copies of any contract or other document out of or in relation to which the dispute arises.
...
Arbitration Fee for disputes arising out of agreements concluded on the [Confideal](https://confideal.io) platform is determined by terms and conditions of the [Confideal](https://confideal.io)
...
Keys and signatures used should follow the [OpenPGP](https://en.wikipedia.org/wiki/Pretty_Good_Privacy#OpenPGP) standard ([RFC 4880](https://tools.ietf.org/html/rfc4880)), for transactions on the Ethereum blockchain Ethereum keys verified via [cryptonomica.net](https://cryptonomica.net) can be used.
