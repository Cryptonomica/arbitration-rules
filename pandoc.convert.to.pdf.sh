...
pandoc -N --template=mytemplate.tex --variable version=2.0 -s ./Arbitration_Rules/Cryptonomica/Cryptonomica-Arbitration-Rules.EN.md -o ./Arbitration_Rules/Cryptonomica/Cryptonomica-Arbitration-Rules.EN.md.pdf
